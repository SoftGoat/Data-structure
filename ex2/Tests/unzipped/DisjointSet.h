...
private:
    ...
    const int INITIAL_CAPACITY = 101; ///< Initial capacity of the hash table
...
public:
    ...
    /**
     * @brief Destroys the DisjointSet object.
     * 
...
DisjointSet<ValueType, KeyType, HashFunc>::DisjointSet(size_t initialCapacity = INITIAL_CAPACITY)
